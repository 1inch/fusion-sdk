...
sdk.placeOrder({
    ...
    takingFeeRatio: 100, // optional field, 1% as we use bps format, 1% is equal to 100bps
    takingFeeReceiver: '0x0000000000000000000000000000000000000000' //  optional field, fee receiver address
}).then(console.log)
```
