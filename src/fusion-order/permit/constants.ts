...
// todo: update
const PERMIT2_PROXY_ADDRESS = '0x0000000000000000000000000000000000000000'
const PERMIT2_PROXY_ADDRESS_ZK = '0x0000000000000000000000000000000000000000'

export const PERMIT2_PROXY_ADDRESSES: Record<NetworkEnum, string> = {
    [NetworkEnum.ZKSYNC]: PERMIT2_PROXY_ADDRESS_ZK,
    [NetworkEnum.ARBITRUM]: PERMIT2_PROXY_ADDRESS,
    [NetworkEnum.ETHEREUM]: PERMIT2_PROXY_ADDRESS,
    [NetworkEnum.POLYGON]: PERMIT2_PROXY_ADDRESS,
    [NetworkEnum.BINANCE]: PERMIT2_PROXY_ADDRESS,
    [NetworkEnum.AVALANCHE]: PERMIT2_PROXY_ADDRESS,
    [NetworkEnum.OPTIMISM]: PERMIT2_PROXY_ADDRESS,
    [NetworkEnum.FANTOM]: PERMIT2_PROXY_ADDRESS,
    [NetworkEnum.GNOSIS]: PERMIT2_PROXY_ADDRESS,
    [NetworkEnum.COINBASE]: PERMIT2_PROXY_ADDRESS,
    [NetworkEnum.LINEA]: PERMIT2_PROXY_ADDRESS,
    [NetworkEnum.SONIC]: PERMIT2_PROXY_ADDRESS,
    [NetworkEnum.UNICHAIN]: PERMIT2_PROXY_ADDRESS
}
